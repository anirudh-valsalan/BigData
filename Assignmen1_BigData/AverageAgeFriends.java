...
public class AverageAgeFriends 
{
			 ...
			 String arr[] = value.toString().split(",");
	            ...
	            String[] cal=arr[9].toString().split("/");
				 ...
				 Date now = new Date();
				    ...
				    String data=arr[1]+","+","+arr[3]+","+arr[4]+","+arr[5];
				outvalue.set("R:" + data);
	...
	public static class AverageAgeMapper extends Mapper<LongWritable, Text, AverageAgeCustom, Text> 
	{
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			String line[] = m[1].split(",");
             ...
             context.write(new AverageAgeCustom(Float.parseFloat(m[0]),Float.parseFloat(line[4])), new Text(m[1].toString()));
			}		
		}
	...
	public static void main(String[] args) throws Exception 
	{
		...
		job.setJarByClass(AverageAgeFriends.class);
		...
		job1.setJarByClass(AverageAgeFriends.class);
